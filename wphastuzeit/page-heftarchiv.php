...
<?php get_header(); ?>
			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<h2 class="accordionButton">2014</h2>
				
				<div class="accordionContent">
				
					<!-- Hefte 2014 Loop -->
					<?php
						$postslist = query_posts('category_name=Heftarchiv&showposts=-1&year=2014');
				...
				<h2 class="accordionButton">2013</h2>
				
				<div class="accordionContent">
				
					<!-- Hefte 2013 Loop -->
					<?php
						$postslist = query_posts('category_name=Heftarchiv&showposts=-1&year=2013');
					 	foreach ($postslist as $post) : 
					    setup_postdata($post);
					?>
				...
				<h2 class="accordionButton">2012</h2>
				
				<div class="accordionContent">
				
					<!-- Hefte 2012 Loop -->
					<?php
						$postslist = query_posts('category_name=Heftarchiv&showposts=-1&year=2012');
					 	foreach ($postslist as $post) : 
					    setup_postdata($post);
					?>
